...
export default function Deliveries() {
  ...
  const hasActiveDelivery =
    !!currentDelivery && currentDelivery.status !== "handed_off";
    ...
    <div className="flex flex-col gap-5">
      ...
      <div>
        ...
        <div className="flex gap-2 flex-wrap">
          {[
            ...
            {
              label: "Completed",
              value: historyDeliveries.filter((d) => d.status === "delivered")
                .length,
              rgb: "34,197,94",
            },
            {
            ...
            <div
              ...
              style={{
                ...
                border: `1px solid rgba(${pill.rgb},0.12)`,
                borderRadius: 10,
                padding: "5px 11px",
                display: "flex",
                alignItems: "center",
      ...
      {currentDelivery ? (
        ...
        <div
          style={{
            background:
              "linear-gradient(145deg, rgba(168,85,247,0.04), #1a2332 30%, #141c2c)",
            borderRadius: 16,
        ...
        >
          ...
          >
            {pendingDeliveries.length > 0
              ? "Accept a pending delivery below to get started"
      ...
      <div style={{ position: "relative" }}>
        <Search
          ...
          style={{
            ...
            color: searchFocused ? "#3b82f6" : "var(--text-tertiary)",
      ...
      {tab === "active" ? (
        filteredPending.length > 0 ? (
          <div className="flex flex-col gap-3">
            {filteredPending.map((delivery) => (
              <PendingCard
                ...
                onToggle={() =>
                  setExpandedCard(
                    expandedCard === delivery.id ? null : delivery.id,
                  )
                }
          ...
          <EmptyState
            ...
            subtitle="New assignments from admin will show up here"
          />
        )
...
function CurrentDeliveryCard({
  ...
  // Step indicator
  const isAirSea =
    delivery.serviceType === "AIR" || delivery.serviceType === "SEA";
  const steps = [
    {
      label: "Assigned",
      done: ["assigned", "picked_up", "in_transit", "handed_off"].includes(
        delivery.status,
      ),
    ...
    {
      label: "Picked Up",
      done: ["picked_up", "in_transit", "handed_off"].includes(delivery.status),
      active: delivery.status === "picked_up",
    },
    {
      label: "In Transit",
      done: ["in_transit", "handed_off"].includes(delivery.status),
    ...
    ...(isAirSea
      ? [
          {
            label: "Handed Off",
            done: delivery.status === "handed_off",
            active: delivery.status === "handed_off",
          },
        ]
      : []),
  ];
            ...
            >
                ...
                {step.done ? (
                  ...
                  <span
                    style={{
                      fontSize: 10,
                      fontWeight: 700,
                      color: step.active ? "#fff" : "var(--text-tertiary)",
                    }}
                  >
                    {i + 1}
                  </span>
              ...
              <span
                style={{
                  ...
                  fontWeight: 600,
                  color:
                    step.done || step.active ? "#fff" : "var(--text-tertiary)",
                }}
              >
                {step.label}
              </span>
          ...
          {delivery.status === "handed_off" && (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                {delivery.serviceType === "AIR" ? (
                  <Plane size={14} style={{ color: "#f97316" }} />
                ) : (
                  <Ship size={14} style={{ color: "#f97316" }} />
                )}
                <span
              ...
              >
                Admin will track this shipment until it arrives at the
                destination hub.
              </p>
            </div>
          )}
        ...
        >
          ...
          <div className="flex gap-3 mb-3">
            ...
            <div className="flex flex-col gap-2 flex-1 min-w-0">
              <div>
                ...
                <p
                  className="truncate"
                  style={{ fontSize: 12, color: "#fff", marginTop: 1 }}
                >
                  {delivery.pickupAddress}
                </p>
              </div>
          ...
          >
            <span className="flex items-center gap-1">
              <Clock size={11} style={{ color: "#f59e0b" }} /> ETA{" "}
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (!locked) onAccept(delivery.id);
              }}
              disabled={locked}
              style={{
                height: 38,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-end shrink-0">
        ...
        >
          {isDone ? formatNaira(delivery.earnings) : "Failed"}
        </span>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 20px 24px" }}>
            ...
            {[
              {
                label: "Service Type",
                value:
                  SERVICE_LABELS[delivery.serviceType] || delivery.serviceType,
                icon: <Truck size={13} />,
              },
              {
                label: "Package Type",
                value: delivery.packageType || "—",
              ...
              ...(delivery.distance > 0
                ...
                : []),
              ...(delivery.declaredValue > 0
                ? [
                    {
                      label: "Declared Value",
                      value: formatNaira(delivery.declaredValue),
          ...
          >
            ...
            {[
              ...
              {
                label: "Scheduled",
                value: new Date(delivery.scheduledAt).toLocaleString("en-GB", {
                  day: "numeric",
                  month: "short",
                  year: "numeric",
                  hour: "2-digit",
              ...
              {
                label: "ETA",
                value: delivery.estimatedArrival
              ...
              {
                label: "Earnings",
                value: formatNaira(delivery.earnings),
                icon: <DollarSign size={13} />,
                green: true,
              },
            ].map((row, i, arr) => (
